...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (addTableForm) {
        ...
        console.warn("addTableForm not found on this page.");
    }
    ...
    function loadTablesList() {
        ...
        const tableList = document.getElementById("tableList");
        if (!tableList) {
            console.warn("tableList element not found.");
            return;
        }
    ...
    if (addMenuItemForm) {
        ...
        console.warn("addMenuItemForm not found on this page.");
    }
    ...
    // Make deleteMenuItem globally accessible for inline onclick
    ...
    function loadReports() {
        ...
        if (
            ...
            console.error("Missing elements in reports.html:", {
        ...
        function displayCreditors() {
            ...
            const totalPaidAmount = allCredits
                .reduce(
                    (sum, order) =>
                        sum + (order.payment.creditor.paymentHistory || []).reduce((ps, p) => ps + parseFloat(p.amount), 0),
                    0
                )
                .toFixed(2);
        ...
        // Make deleteOrder globally accessible for inline onclick
        ...
        // Make markCreditPaid globally accessible for inline onclick
